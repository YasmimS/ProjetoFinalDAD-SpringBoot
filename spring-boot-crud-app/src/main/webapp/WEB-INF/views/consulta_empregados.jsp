...
<br>
	...
	<section class="signup">
				...
				<a href="${pageContext.request.contextPath}/empregado/deletarTodos" style="float: right;" class="signup-image-link" onclick="return confirm('Têm certeza de que deseja excluir todos os funcionários?');" title="Excluir todos os funcionários"><i class="fa fa-trash-o" aria-hidden="true"></i></a><br>
				...
				<c:set var="count" value="${count + 1}" scope="page"/>
					<tr>
						...
						<td> <a href="${pageContext.request.contextPath}/empregado/atualizarEmpregado/${Empregado.id}" title="Alterar"><i class="fa fa-edit"></i></a> |
						 <a href="${pageContext.request.contextPath}/empregado/deletarEmpregado/${Empregado.id}" onclick="return confirm('Têm certeza de que deseja excluir ${Empregado.primeiroNome} ${Empregado.ultimoNome} ?');" title="Excluir"><i class="fa fa-trash" aria-hidden="true"></i></a> </td>
					</tr>
				</c:forEach>
				</c:when>
				<c:otherwise>
					<center><h1>Nenhum Funcionário Encontrado.</h1></center>
				</c:otherwise>
			</c:choose>
